...
public class ClsFragmentoSolicitarFichaje extends Fragment {
    ...
    public boolean validarHoras (){
        ...
        System.out.println("Integer.parseInt(horaInicioJornada[0]) --> " + Integer.parseInt(horaInicioJornada[0]));
        System.out.println("Integer.parseInt(horaInicioDescanso[0]) --> " + Integer.parseInt(horaInicioDescanso[0]));
        System.out.println("Integer.parseInt(horaFinalJornada[0]) --> " + Integer.parseInt(horaFinalJornada[0]));
        System.out.println("Integer.parseInt(Integer.parseInt(horaInicioDescanso[1]) --> " + Integer.parseInt(horaInicioDescanso[1]));
        System.out.println("Integer.parseInt(horaFinalDescanso[1])) --> " + Integer.parseInt(horaFinalDescanso[1]));
        ...
        if (Integer.parseInt(horaInicioJornada[0]) >= Integer.parseInt(horaInicioDescanso[0]) ||
           ...
           // mostrarError("","La hora de inicio de la jornada debe de ser la menor hora");
            ...
            horasCorrectas = false;
            ClsUtils.MostrarMensajes(getContext(),"La hora de inicio del descanso debe de ser menor que el fin de la jornada","",true,ClsUtils.actividadEnum.ERROR);

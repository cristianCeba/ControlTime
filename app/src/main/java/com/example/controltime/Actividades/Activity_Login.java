...
public class Activity_Login extends AppCompatActivity implements BiometricCallback {
    ...
    public ImageView imgHuella;
    public TextView textCorreo,textContraseña,resetPassword,testHuella;
  ...
  //  private static  final String URL_RECUPERAR_DATOS_SOCIO_EMAIL="https://us-central1-controltime-b575f.cloudfunctions.net/GetUsuarioXEmail?email=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgHuella = findViewById(R.id.imageHuella);
        testHuella = findViewById(R.id.textHuella);
        utils = new ClsUtils();

        testHuella.setVisibility(View.INVISIBLE);
        imgHuella.setVisibility(View.INVISIBLE);

        testHuella.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        imgHuella.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                pedirHuellaDactilar();
            }
    ...
    private void sesionGuardada (){
        ...
        mAuth.signInWithEmailAndPassword(correo, contrasena)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            testHuella.setVisibility(View.VISIBLE);
